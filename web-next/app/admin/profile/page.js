          ...
          <div className="flex gap-6">
            ...
            <div className="w-full flex gap-6">
              <div className="flex flex-1 flex-col gap-6">
                {/* top container */}
                <div className="flex flex-col md:flex-row gap-6 items-center p-6 rounded-2xl shadow-md bg-white">
                ...
                <div className="flex flex-col p-6 rounded-2xl shadow-md bg-white gap-10">
                  <div className="flex flex-col gap-4">
                    <h3 className="text-xl font-medium">Basic information</h3>

                    <div className="grid grid-cols-4 gap-4">
                      <div className="col-span-4 md:col-span-2 p-4 rounded-lg group bg-gray-300/20 transition-shadow hover:shadow-md flex flex-col gap-1">
                        <span className="text-sm text-gray-500 group-hover:text-blue-500 transition-colors duration-150">
                          Fullname
                        </span>
                        <h3 className="font-medium text-lg group-hover:text-blue-500 transition-colors duration-150">
                          Edward Gatbonton
                        </h3>
                      </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="col-span-2 md:col-span-1 p-4 rounded-lg group bg-gray-300/20 transition-shadow hover:shadow-md flex flex-col gap-1">
                        <span className="text-sm text-gray-500 group-hover:text-blue-500 transition-colors duration-150">
                          Email
                        </span>
                        <h3 className="font-medium text-lg group-hover:text-blue-500 transition-colors duration-150">
                      ...
                      <div className="col-span-2 p-4 rounded-lg group bg-gray-300/20 transition-shadow hover:shadow-md flex flex-col gap-1">
                        <span className="text-sm text-gray-500 group-hover:text-blue-500 transition-colors duration-150">
                          Residential address
                        </span>
                        <h3 className="font-medium text-lg group-hover:text-blue-500 transition-colors duration-150">
              ...
              <div className="w-80 xl:w-96 hidden lg:block">
                <div className="rounded-2xl bg-white shadow-md p-6 flex">
                    Notifications
                </div>
              </div>
            </div>
