...
export default function BatchReview() {
  ...
  const overviewData = selectedBatch
    ...
    : {
        totalDefects: batchReviews.length,
        uniqueDefectTypes: new Set(
          batchReviews.map((batch) => batch.defectType)
        ).size,
        timeRange: "11:16:47 PM - 11:18:57 PM",
      };
            ...
            <div className="flex items-center gap-4 border rounded-lg p-4">
              ...
              <div className="flex flex-1 flex-col gap-1">
                ...
                <span className="text-4xl font-semibold text-orange-500">
                  {overviewData.uniqueDefectTypes}
                </span>
              </div>
            </div>
