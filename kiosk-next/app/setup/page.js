      ...
      <div className="max-w-3xl mx-auto">
        ...
        {state.step === "generate" ? (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-md p-6">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500">Follow the guide below to set up your MEGG machine</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <div className="mb-6">
                <h2 className="text-2xl font-semibold">Set Up PIN</h2>
                <p className="text-gray-500">Create a secure PIN for your machine</p>
              </div>
              ...
              <PinInput
                ...
                onStepChange={(pinStep) => updateState({ pinStep, pinError: "", confirmPin: "" })}
